 ...
 * 
 *         This algorithm will work on a BaysianNetwork to compute the prior/posterior
 *         probability of a variable given evidences.
 *
 *         The object has the method ask, which is used to query the
 *         probability. This method can be invoked with a bayse network instance
...
public class VariableElimination implements Inference{
	...
	private static VariableElimination instance = null;
	 ...
	 */
	public static VariableElimination getInstance(BayesianNetwork network) {
		if (instance == null)
			instance = new VariableElimination(network);
		return instance;
	}

	private VariableElimination(BayesianNetwork network) {
